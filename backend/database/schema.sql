...
CREATE TABLE IF NOT EXISTS clients (
  ...
  status ENUM('CREATED', 'QR_READY', 'CONNECTED', 'READY', 'LOGOUT', 'DISCONNECTED') NOT NULL DEFAULT 'CREATED',
...
CREATE TABLE IF NOT EXISTS bulk_queue_status (
  ...
  send_interval_min_minutes INT UNSIGNED NOT NULL DEFAULT 2,
  send_interval_max_minutes INT UNSIGNED NOT NULL DEFAULT 5,
  created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
